...
const ContentBackground = ({ poster }: { poster: string }) => {
  return (
    <div className={`absolute inset-0 left-0 lg:left-1/4 h-[69%] -z-30  `}>
      <div className="absolute inset-0  bg-gradient-to-l from-transparent from-[40%]  to-background -z-10 " />
